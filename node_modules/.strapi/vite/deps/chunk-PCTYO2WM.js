...
} from "./chunk-DSZN4VEO.js";
import {
  index
} from "./chunk-TCSMLMMP.js";
import {
  getTimezoneOffset,
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-O6BIH2MM.js";
import {
  useConfig
} from "./chunk-7QK7DDHA.js";
import {
  AssetSource,
  AssetType,
...
import {
  useDocumentActions
} from "./chunk-C5OLHJIB.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-KVXYAABX.js";
import {
  renderAdmin
} from "./chunk-NDJ5RFWK.js";
import {
  useLicenseLimits
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-VCVDO2CE.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-6MDSSUFC.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-P7C2HM57.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-GLLA26DY.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-AI7PBREF.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-DF2ZGVGA.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-6DG3QQRO.js");
          return {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-T3YVKUYY.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-VO4P7UGP.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-SUO5ZETA.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-6IIGIIPW.js");
          return {
...
//# sourceMappingURL=chunk-PCTYO2WM.js.map
